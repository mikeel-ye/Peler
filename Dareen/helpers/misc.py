...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("Dareen").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("Dareen").info(f"Invalid Git Command")
        ...
        LOGGER("Dareen").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("Dareen").info(f"Heroku App Configured")
